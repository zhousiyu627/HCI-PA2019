...
var y = i(12),
  ...
  B = 4e3,
  G = 5e3,
  F = "__flag_in_main_process",
  H = "_hasGradientOrPatternBg",
  W = "_optionUpdated";
...
Z._onframe = function() {
  ...
  if (this[F] = !0, !this._model || e) {
    var n = new w(this._api),
      r = this._theme,
      o = this._model = new x(null, null, r, n);
  ...
  if (y.canvasSupported) {
    ...
    if (et[e]) {
      ...
      for (var c in tt) {
        var d = tt[c];
        if (d.group === e) {
          var f = d.getRenderedCanvas(C.clone(t)),
    ...
    if (e) {
      ...
      if (a.isSingleCanvas && a.isSingleCanvas()) r.configLayer(0, {
        ...
        o.colorStops || o.image ? (r.configLayer(0, {
          clearColor: o
        }), this[H] = !0, this._dom.style.background = "transparent") : (this[H] && r.configLayer(0, {
          clearColor: null
        }), this[H] = !1, this._dom.style.background = o)
      }
    }
  },
...
ot.init = function(t, e, i) {
  ...
  "function" == typeof t && (e = t, t = O), Y.push({
    prio: t,
    func: e
  })
}, ot.registerAction = function(t, e, i) {
  "function" == typeof e && (i = e, e = "");
  var n = C.isObject(t) ? t.type : [t, t = {
    event: e
  }][0];
  t.event = (t.event || n).toLowerCase(), e = t.event, U[n] || (U[n] = {
    action: i,
    actionInfo: t
  }), X[e] = n
  ...
  "function" == typeof t && (e = t, t = R), Q.push({
    prio: t,
    func: e,
    isLayout: !0
  })
}, ot.registerVisual = function(t, e) {
  "function" == typeof t && (e = t, t = V), Q.push({
    prio: t,
    func: e
  })
...
function(t, e, i) {
  ...
  a.formatTpl = function(t, e) {
    ...
    for (var u = 0; i > u; u++)
      for (var h = 0; h < r.length; h++) t = t.replace(l(s[h], u), e[u][r[h]]);
    return t
  };
  var u = function(t) {
    return 10 > t ? "0" + t : t
...
function(t, e, i) {
  ...
  }), s.enableSubTypeDefaulter(h), s.enableTopologicalTravel(h, n), o.mixin(h, i(126)), t.exports = h
},
function(t, e, i) {
  var n = i(8),
    r = i(4),
  ...
  s.normalizeToArray = function(t) {
    ...
    function i(t, e, i) {
      for (var n = 0, r = t.length; r > n; n++)
        for (var o = t[n].seriesId, a = s.normalizeToArray(t[n].dataIndex), l = i && i[o], u = 0, h = a.length; h > u; u++) {
          var c = a[u];
...
function(t, e, i) {
  (function(e) {
    ...
    function r(t, e) {
      var i = t.dimensions,
        n = new m(d.map(i, t.getDimensionInfo, t), t.hostModel);
      v(n, t);
    ...
    y.type = "list", y.hasItemOption = !0, y.getDimension = function(t) {
      ...
      for (var e = this.dimensions, i = this._dimensionInfos, n = 0, r = e.length; r > n; n++)
      ...
      for (var u = 0; u < l.length; u++) {
        var h;
        if (1 === s) h = e.call(r, this.get(t[0], u, i), u);
        else {
  ...
  var n = i(1),
    ...
    c = a.extend({
      ...
      fillDataTextStyle: function(t) {
        if (t)
          for (var e = 0; e < t.length; e++) t[e] && t[e].label && o.defaultEmphasis(t[e].label, o.LABEL_OPTIONS)
      },
...
function(t, e, i) {
  ...
  var l = i(20),
    u = "undefined" != typeof window && !!window.addEventListener,
    h = u ? function(t) {
...
function(t, e, i) {
  ...
  function o(t, e, i) {
    var n = e && e.dataIndex,
      o = e && e.name;
    if (null != n)
      for (var a = n instanceof Array ? n : [n], s = 0, l = a.length; l > s; s++) r(t.getItemGraphicEl(a[s]), i);
    else if (o)
      for (var u = o instanceof Array ? o : [o], s = 0, l = u.length; l > s; s++) {
    ...
    h = o.extend({
      ...
      getTicks: function() {
        ...
        if (t) {
          ...
          e[0] < r[0] && i.push(e[0]);
          for (var a = r[0]; a <= r[1];)
            if (i.push(a), a = u(a + t, o), i.length > n) return [];
          e[1] > r[1] && i.push(e[1])
        }
        return i
      },
      ...
      niceTicks: function(t) {
        ...
        if (isFinite(i)) {
          0 > i && (i = -i, e.reverse());
          var r = u(n.nice(i / t, !0), Math.max(l(e[0]), l(e[1])) + 2),
            o = l(r) + 2,
        ...
        t && d(function(e) {
          if (t) {
            ...
            if (r.length && !n.length)
              for (var o = 0, a = r.length; a > o; o++) "category" === r[o].get("type") && n.push(o);
    ...
    execute: function() {
      ...
      for (var t = 0; t < u.length; t++) {
        ...
        if (s.hasOwnProperty(h)) {
          ...
          if (null == c) continue;
          if (c.length)
            for (var f = 0, d = c.length; d > f; f++) this._add && this._add(c[f]);
...
function(t, e, i) {
  ...
  h._createSymbol = function(t, e, i) {
    ...
    l.initProps(u, {
      scale: h
    }, r, i), this._symbolType = t, this.add(u)
    ...
    if (r !== this._symbolType) this._createSymbol(r, t, e);
    else {
  ...
  var x = {
      ...
      axisTick: function() {
        ...
        if (t.get("axisTick.show"))
          for (var e = t.axis, i = t.getModel("axisTick"), n = this.opt, r = i.getModel("lineStyle"), o = i.get("length"), a = b(i, n.labelInterval), l = e.getTicksCoords(i.get("alignWithLabel")), h = e.scale.getTicks(), c = [], d = [], f = this._transform, p = 0; p < l.length; p++)
            if (!_(e, p, a)) {
              var v = l[p];
      ...
      axisLabel: function() {
        ...
        var e = this.opt,
          i = this.axisModel,
          o = v(e.axisLabelShow, i.get("axisLabel.show"));
        if (o) {
          var s = i.axis,
          ...
          g = g * m / 180;
          for (var y = r(e, g, e.labelDirection), x = i.get("data"), b = [], w = a(i), S = i.get("triggerEvent"), M = 0; M < f.length; M++)
            if (!_(s, M, e.labelInterval)) {
              var T = c;
              x && x[M] && x[M].textStyle && (T = new h(x[M].textStyle, c, i.ecModel));
              var A = T.getTextColor() || i.get("axisLine.lineStyle.color"),
                I = s.dataToCoord(f[M]),
                L = [I, e.labelOffset + e.labelDirection * d],
                C = s.scale.getLabel(f[M]),
                D = new u.Text({
                  anid: "label_" + f[M],
                  style: {
                    text: p[M],
    ...
    function r(i) {
      return function(r, l) {
        if (n(r, t, e)) {
          ...
          var c = new f(i, h.createScaleByModel(r), [0, 0], r.get("type"), u),
            d = "category" === c.type;
...
function(t, e, i) {
  ...
  function s(t, e, i, n, r) {
    var a = t.length;
    if (1 == r)
      for (var s = 0; a > s; s++) n[s] = o(t[s], e[s], i);
    else
      for (var l = t[0].length, s = 0; a > s; s++)
        for (var u = 0; l > u; u++) n[s][u] = o(t[s][u], e[s][u], i)
  }
  ...
  function l(t, e, i) {
    ...
    if (n !== r) {
      ...
      if (o) t.length = r;
        ...
        for (var a = n; r > a; a++) t.push(1 === i ? e[a] : x.call(e[a]))
    }
    for (var s = t[0] && t[0].length, a = 0; a < t.length; a++)
      if (1 === i) isNaN(t[a]) && (t[a] = e[a]);
      else
        for (var l = 0; s > l; l++) isNaN(t[a][l]) && (t[a][l] = e[a][l])
  }
  ...
  function h(t, e, i, n, r, o, a, s, l) {
    var u = t.length;
    if (1 == l)
      for (var h = 0; u > h; h++) s[h] = c(t[h], e[h], i[h], n[h], r, o, a);
    else
      for (var d = t[0].length, h = 0; u > h; h++)
        for (var f = 0; d > f; f++) s[h][f] = c(t[h][f], e[h][f], i[h][f], n[h][f], r, o, a)
  }
    ...
    if (x) {
      ...
      if (!C) {
        ...
        var W = function(t, e) {
            ...
            if (0 !== n)
              if (E = (e - A[i]) / n, m)
                if (N = I[i], R = I[0 === i ? i : i - 1], V = I[i > x - 2 ? x - 1 : i + 1], B = I[i > x - 3 ? x - 1 : i + 2], w) h(R, N, V, B, E, E * E, E * E * E, d(t, r), T);
                else {
                  var l;
                  if (S) l = h(R, N, V, B, E, E * E, E * E * E, H, 1), l = f(H);
                  else {
                    if (M) return a(N, V, E);
    ...
    d = function(t, e) {
      ...
      if (e && !r(e) && !s.isArray(e.coord) && n) {
        ...
        if (e = s.clone(e), e.type && c[e.type] && a.baseAxis && a.valueAxis) {
          ...
          for (var d = [null != e.xAxis ? e.xAxis : e.radiusAxis, null != e.yAxis ? e.yAxis : e.angleAxis], p = 0; 2 > p; p++)
            if (c[d[p]]) {
      ...
      if (!e.isSeriesFiltered(t)) {
        ...
        o.each(function(t) {
          ...
          var a = n.getItemModel(e),
            s = r[e],
            l = null != s && o.getItemVisual(s, "color", !0);
      ...
      function a(e, i) {
        ...
        if (f) {
          var h = u.shape,
            c = d ? "height" : "width",
            g = {};
          h[c] = 0, g[c] = a[c], o[i ? "updateProps" : "initProps"](u, {
            shape: g
          }, t, e)
        }
        return u
    ...
    if (e || i || !n.ignore) {
      ...
      if (this.__dirty || a.__dirty) {
        ...
        if (!n.ignore) {
          n.attr("position", u);
          var f, p, g, v = 5 * r;
          if ("end" === n.__position) f = [c[0] * v + u[0], c[1] * v + u[1]], p = c[0] > .8 ? "left" : c[0] < -.8 ? "right" : "center", g = c[1] > .8 ? "top" : c[1] < -.8 ? "bottom" : "middle";
...
function(t, e, i) {
  ...
  function u(t, e, i) {
    ...
    return e && (f.shape[a ? "width" : "height"] = 0, x.initProps(f, {
      shape: {
        width: u,
        height: h
      }
  ...
  function h(t, e, i) {
    ...
    return e && (l.shape.endAngle = -a[0] * s, x.initProps(l, {
      shape: {
        endAngle: -a[1] * s
      }
    }, i)), l
  ...
  function p(t, e) {
    ...
    if (i && i.length) {
      for (var n, r = i.length - 1; r >= 0; r--)
        ...
        var h = l[0],
          c = l[l.length - 1],
          d = h.interval ? f(h.interval[0], s) : h.value,
        ...
        for (var r = 0; r < l.length; r++)
          if (l[r].interval) {
            ...
            u.push({
              ...
              offset: (f(l[r].interval[1], s) - d) / g,
              color: l[r].color
            })
          } else u.push({
            offset: (l[r].value - d) / g,
            color: l[r].color
          });
        var v = new x.LinearGradient(0, 0, 0, 0, u, !0),
          m = e.getAxis(a),
  ...
  t.exports = b.extend({
    ...
    render: function(t, e, i) {
      var o = t.coordinateSystem,
        ...
        M = s(o, l),
        T = t.get("showSymbol"),
        A = T && !v && !t.get("showAllSymbol") && this._getSymbolIgnoreFunc(l, o),
        I = this._data;
      ...
      x && m.type === o.type && L === this._step ? (S && !_ ? _ = this._newPolygon(f, M, o, w) : _ && !S && (b.remove(_), _ = this._polygon = null), b.setClipPath(c(o, !1, t)), T && y.updateData(l, A), l.eachItemGraphicEl(function(t) {
        t.stopAnimation(!0)
      }), n(this._stackedOnPoints, M) && n(this._points, f) || (w ? this._updateAnimation(l, M, o, i, L) : (L && (f = d(f, o, L), M = d(M, o, L)), x.setShape({
        points: f
      }), _ && _.setShape({
        points: f,
        stackedOnPoints: M
      ...
      x.useStyle(g.defaults(u.getLineStyle(), {
        fill: "none",
        stroke: C,
        lineJoin: "bevel"
      }));
      ...
      if (D = r(t.get("smooth")), x.setShape({
        ...
        var P = l.stackedOn,
          k = 0;
        if (_.useStyle(g.defaults(h.getAreaStyle(), {
            fill: C,
            opacity: .7,
            lineJoin: "bevel"
          })), P) {
    ...
    _updateAnimation: function(t, e, i, n, r) {
      var o = this._polyline,
        a = this._polygon,
        s = t.hostModel,
        l = y(this._data, t, this._stackedOnPoints, e, this._coordSys, i),
        u = l.current,
        h = l.stackedOnCurrent,
        c = l.next,
        f = l.stackedOnNext;
      r && (u = d(l.current, i, r), h = d(l.stackedOnCurrent, i, r), c = d(l.next, i, r), f = d(l.stackedOnNext, i, r)), o.shape.__points = l.current, o.shape.points = u, x.updateProps(o, {
        shape: {
          points: c
        }
      }, s), a && (a.setShape({
...
function(t, e, i) {
  ...
  function n(t, e, i, n, r, o, a) {
    ...
    function u(t, e, i, n, r, o) {
      for (var a = o > 0 ? e ? Number.MAX_VALUE : 0 : e ? Number.MAX_VALUE : 0, s = 0, l = t.length; l > s; s++)
  ...
  t.exports = function(t, e, i, n) {
    ...
    l.each(function(i) {
      ...
      if ("center" === v) n = f.cx, r = f.cy, d = "center";
      else {
    ...
    c = i(2).extendComponentView({
      ...
      _splitLine: function(t, e, i) {
        var n = t.axis,
          ...
          c = l(a, i);
        h = r.isArray(h) ? h : [h];
        for (var d = e.coordinateSystem.getRect(), f = n.isHorizontal(), p = 0, g = n.getTicksCoords(), v = n.scale.getTicks(), m = [], y = [], x = u.getLineStyle(), _ = 0; _ < g.length; _++)
          if (!s(n, _, c)) {
...
function(t, e, i) {
  ...
  function P(t, e) {
    ...
    if (t._brushType) {
      for (var o, a = t._panels, s = t._covers, l = 0; l < s.length; l++)
        if (nt[s[l].__brushOption.brushType].contain(s[l], i, n)) {
          o = !0;
          break
        } o || (a ? W(a, function(t) {
  ...
  function O(t, e, i) {
    ...
    if (t._track.push(t.group.transformCoordToLocal(r, o)), v(t) || u) {
      ...
      if (u) {
        var g = nt[t._brushType],
          m = u.__brushOption;
        m.range = g.getCreatingRange(C(t, u, t._track)), i && (s(t, u), g.updateCommon(t, u)), l(t, u), n = {
          isEnd: i
        }
      }
...
function(t, e, i) {
  ...
  var r = "\x00_ec_interaction_mutex",
    o = {
      take: function(t, e, i) {
        var r = n(t);
        r[e] = i
  ...
  function o(t, e) {
    ...
    s.each(t, function(t, e) {
      var o = t.getData(),
        ...
        s = a.getBaseAxis(),
        l = s.getExtent(),
        h = "category" === s.type ? s.getBandWidth() : Math.abs(l[1] - l[0]) / o.count(),
        c = i[r(s)] || {
          bandWidth: h,
          remainedWidth: h,
          autoWidthCount: 0,
        ...
        function e(e, r) {
          ...
          i[e] = [], n[e] = [], p(u, function(t, r) {
            ...
            if (c.assert(x(a) || o, "Empty component definition"), a) {
              ...
              if (o && o instanceof s) o.mergeOption(a, this), o.optionUpdated(a, !1);
              else {
                var l = c.extend({
                  dependentModels: h,
                  componentIndex: r
...
function(t, e, i) {
  ...
  h.prototype = {
    ...
    mouseout: function(t) {
      this.dispatchToElement(this._hovered, "mouseout", t), this.trigger("globalout", {
        event: t
      })
    },
    resize: function(t) {
  ...
  u.prototype = {
    ...
    _animateToShallow: function(t, e, i, n, o) {
      var a = {},
        l = 0;
      for (var u in i)
        if (null != e[u]) s(i[u]) && !r.isArrayLike(i[u]) ? this._animateToShallow(t ? t + "." + u : u, e[u], i[u], n, o) : (a[u] = i[u], l++);
        else if (null != i[u])
        if (t) {
          var h = {};
  ...
  function r(t) {
    ...
    for (e = 1; e < o.length; e++) {
      var d, f = o[e],
        p = f.charAt(0),
        g = 0,
        v = f.slice(1).replace(/e,-/g, "e-").split(",");
...
function(t, e, i) {
  ...
  function r(t, e, i, n, r, s) {
    ...
    if (l) {
      var u = o(e, l, n),
        h = u.pixel - u.pixelStart,
        c = h / u.pixelLength * (i[1] - i[0]) + i[0];
        ...
        a.each(t.getData(), function(a) {
          ...
          if (!f[u])
            if (p) {
              ...
              var m = g.getVisual("legendSymbol") || "roundRect",
...
function(t, e, i) {
  ...
  function a(t, e, i, r, o) {
    var a, s = r.coordinateSystem,
      l = t.getItemModel(e),
      u = h.parsePercent(l.get(i[0]), o.getWidth()),
  ...
  i(68).extend({
    ...
    renderSeries: function(t, e, i, n) {
      ...
      l.isArray(y) || (y = [y, y]), "number" == typeof x && (x = [x, x]), p.from.each(function(t) {
        ...
        }), m.setItemLayout(t, [g.getItemLayout(t), v.getItemLayout(t)]), m.setItemVisual(t, {
...
function(t, e, i) {
  ...
  function r(t, e, i) {
    ...
    var r = new l(n, i),
      o = a.map(i.get("data"), a.curry(u.dataTransform, e));
      ...
      render: function(t, e, i, c) {
        ...
        function f(n, r, s) {
          var l = n.getModel("iconStyle"),
            u = r.getIcons ? r.getIcons() : n.get("icon"),
            h = n.get("title") || {};
          if ("string" == typeof u) {
            var c = u,
              d = h;
          ...
          o.each(u, function(s, u) {
            var c = l.getModel("normal").getItemStyle(),
              ...
              m = 0 === s.indexOf("image://") ? (v.image = s.slice(8), new a.Image({
                style: v
        ...
        if (p.removeAll(), t.get("show")) {
          ...
          o.each(v, function(t, e) {
            ...
            var e = t.__title,
              n = t.hoverStyle;
            if (n && e) {
              var r = h.getBoundingRect(e, n.font),
...
function(t, e, i) {
  ...
  f._onBrush = function(t, e) {
    ...
    if (e.isEnd && t.length) {
      ...
      var s = u.makeCoordInfoList(r(this.model.option), a),
        l = [];
...
function(t, e, i) {
  i(213), i(214), i(2).registerAction({
    type: "showTip",
    event: "showTip",
    update: "none"
...
function(t, e, i) {
  ...
  function u(t, e, i, n, r, o, a) {
    ...
    if (o && c.applyTransform(o.transform), "function" == typeof t && (t = t([e, i], r, n.el, c)), f.isArray(t)) e = v(t[0], u), i = v(t[1], h);
  ...
  i(2).extendComponentView({
      ...
      if (t.from !== this.uid) {
        ...
        if (null == t.x || null == t.y) {
          if (r || e.eachSeries(function(t) {
            ...
            var s, l, u = a.getItemGraphicEl(n),
              c = r.coordinateSystem;
            if (c && c.dataToPoint) {
    ...
    _showAxisTooltip: function(t, e, i) {
      ...
      f.each(this._seriesGroupByAxis, function(t) {
        ...
        var p = !1,
          g = this._lastHover;
        if ("cross" === o) n(g.data, h) && (p = !0), g.data = h;
        else {
          var v = f.indexOf(l, d);
    ...
    _showCartesianPointer: function(t, e, i, n) {
      ...
      if ("cross" === u) a("x", n, e.getAxis("y").getGlobalExtent()), a("y", n, e.getAxis("x").getGlobalExtent()), this._updateCrossText(e, n, t);
      else {
    ...
    _showSinglePointer: function(t, e, i, n) {
      ...
      var a = this,
        s = t.get("type"),
        l = "cross" !== s && "category" === e.getBaseAxis().type,
        u = e.getRect(),
        h = [u.y, u.y + u.height];
      o(i, n, h)
    },
    _showPolarPointer: function(t, e, i, n) {
      ...
      if ("cross" === u) o("angle", n, c.getExtent()), o("radius", n, h.getExtent()), this._updateCrossText(e, n, t);
      else {
    ...
    _dispatchAndShowSeriesTooltipContent: function(t, e, i, n, r) {
      ...
      if (h.payloadBatch && !r && c.dispatchAction({
        ...
        if (r) u(o.get("position"), i[0], i[1], this._tooltipContent, d, null, c);
        else {
          var p = l[0].dataIndex,
    ...
    _showTooltipContent: function(t, e, i, n, r, o, a, s) {
      if (this._ticket = "", t.get("showContent") && t.get("show")) {
        var l = this._tooltipContent,
          ...
          d = e;
        if (h)
          if ("string" == typeof h) d = p.formatTpl(h, i);
  ...
  if (!i(12).canvasSupported) {
    ...
    h.prototype.brushVML = function(t) {
      ...
      if (r) {
        ...
        var Z = F.style;
        if (M) {
          if (e && i) Z.width = g(D * e * c / f) + "px", Z.height = g(k * i * d / m) + "px";
          else {
            var q = new Image,
              j = this;
            q.onload = function() {
    ...
    for (var $ = new r, Q = function(t, e, i, n) {
        ...
        if (o) {
          ...
          var v = this.transform;
          if (v && !n && ($.copy(e), $.applyTransform(v), e = $), n) a = e.x, l = e.y;
          else {
            var m = r.textPosition,
              y = r.textDistance;
            if (m instanceof Array) a = e.x + O(m[0], e.width), l = e.y + O(m[1], e.height), u = u || "left", d = d || "top";
            else {
    ...
    if (!e || "view" === e.type) {
      ...
      o.eachNode(function(t) {
        ...
        var e, i = t.getModel().get("lineStyle.normal.curveness") || 0,
          ...
          a = (r[0] + o[0]) / 2,
          s = (r[1] + o[1]) / 2; + i && (i *= 3, e = [u * i + a * (1 - i), h * i + s * (1 - i)]), t.setLayout([r, o, e])
      })
    }
  }
},
  ...
  t.exports = function(t) {
    t.eachEdge(function(t) {
      var e = t.getModel().get("lineStyle.normal.curveness") || 0,
        ...
        o = [i, r]; + e && o.push([(i[0] + r[0]) / 2 - (i[1] - r[1]) * e, (i[1] + r[1]) / 2 - (r[0] - i[0]) * e]), t.setLayout(o)
    })
  }
},
function(t, e, i) {
  ...
  a.prototype = {
    ...
    draw: function(t, e, i, a, s) {
      ...
      u.each(c.regions, function(e) {
        ...
        i.add(r);
        var o, a = t.getRegionModel(e.name) || t,
          s = a.getModel(g),
          c = a.getModel(v),
          p = n(s, f),
          x = n(c, f),
    ...
    _updateController: function(t, e, i) {
      ...
      o.off("pan").on("pan", function(t, e) {
        i.dispatchAction(u.extend(n(), {
          dx: t,
          dy: e
        }))
      }), o.off("zoom").on("zoom", function(t, e, r) {
        if (i.dispatchAction(u.extend(n(), {
            zoom: t,
            originX: e,
            originY: r
          })), this._updateGroup) {
      ...
      completeVisualOption: function() {
        ...
        function i(t) {
          ...
          p(this.stateList, function(o) {
            ...
            s || (s = t[o] = {
              color: d ? n : [n]
            }), null == s.symbol && (s.symbol = e && r.clone(e) || (d ? "roundRect" : ["roundRect"])), null == s.symbolSize && (s.symbolSize = i && r.clone(i) || (d ? a[0] : [a[0], a[0]])), s.symbol = u(s.symbol, function(t) {
    ...
    r = {
      getItemAlign: function(t, e, i) {
        ...
        for (var a = {
            ...
            ["left", "right", "width"],
            ["top", "bottom", "height"]
          ], u = l[s], h = [0, null, 10], c = {}, d = 0; 3 > d; d++) c[l[1 - s][d]] = h[d], c[u[d]] = 2 === d ? i[0] : r[u[d]];
        var f = [
            ["x", "width", 3],
            ["y", "height", 0]
          ][s],
          p = n.getLayoutRect(c, a, r.padding);
...
function(t, e, i) {
  ...
  function o(t, e, i) {
    ...
    for (var o = t.targetVisuals[i], a = l.prepareVisualTypes(o), s = {}, u = 0, h = a.length; h > u; u++) {
      var c = a[u],
        d = o["colorAlpha" === c ? "__alphaForOpacity" : c];
    ...
    contain: function(t) {
      ...
      if (e.contain(t[0], t[1]))
        for (var n = 0, o = i.length; o > n; n++)
          if (r.contain(i[n], t[0], t[1])) return !0;
      return !1
    },
    transformTo: function(t, e, i, n) {
      var r = this.getBoundingRect(),
        a = r.width / r.height;
      i ? n || (n = i / a) : i = a * n;
      for (var l = new o(t, e, i, n), u = r.calculateTransform(l), h = this.contours, c = 0; c < h.length; c++)
  ...
  t.exports = function(t) {
    t.eachSeriesByType("candlestick", function(t) {
      ...
      n.each(r, function() {
        ...
        function s() {
          var e = t(Math.min(p, g, v, m)),
            i = t(Math.max(p, g, v, m));
...
function(t, e, i) {
  ...
  s.updateData = function(t, e, i) {
    ...
    n.setStyle(r(t, e, "normal", c)), n.ignore = n.normalIgnore = !c.get("show"), n.hoverIgnore = !d.get("show"), i.ignore = i.normalIgnore = !f.get("show"), i.hoverIgnore = !p.get("show"), i.setStyle({
      stroke: h
    }), i.setStyle(f.getModel("lineStyle").getLineStyle()), n.hoverStyle = r(t, e, "emphasis", d), i.hoverStyle = p.getModel("lineStyle").getLineStyle()
...
function(t, e, i) {
  ...
  function o(t) {
    t.each(function(e) {
      ...
      if (d) n = (c[0][0] + c[1][0] + c[2][0] + c[3][0]) / 4, r = (c[0][1] + c[1][1] + c[2][1] + c[3][1]) / 4, i = "center", o = [
        [n, r],
        [n, r]
      ];
      else {
  ...
  t.exports = function(t, e, i) {
    t.eachSeriesByType("funnel", function(t) {
      ...
      var g = t.get("funnelAlign"),
        v = t.get("gap"),
        m = (u.height - v * (i.count() - 1)) / i.count(),
        y = u.y,
        x = function(t, e) {
          var n, r = i.get("value", t) || 0,
            o = s.linearMap(r, [f, p], c, !0);
          switch (g) {
            case "left":
              n = u.x;
              break;
    ...
    h = i(27).extend({
      ...
      _renderMain: function(t, e, i, n, r) {
        for (var o = this.group, s = t.getModel("axisLine"), l = s.getModel("lineStyle"), h = t.get("clockwise"), c = -t.get("startAngle") / 180 * Math.PI, d = -t.get("endAngle") / 180 * Math.PI, f = (d - c) % u, p = c, g = l.get("width"), v = 0; v < n.length; v++) {
          var m = Math.min(Math.max(n[v][0], 0), 1),
            d = c + f * m,
            y = new a.Sector({
              shape: {
                startAngle: p,
          ...
          y.setStyle({
            fill: n[v][1]
          }), y.setStyle(l.getLineStyle(["color", "borderWidth", "borderColor"])), o.add(y), p = d
        }
        var x = function(t) {
          if (0 >= t) return n[0][1];
      ...
      _renderTicks: function(t, e, i, n, o, u, h, c) {
        for (var d = this.group, f = o.cx, p = o.cy, g = o.r, v = t.get("min"), m = t.get("max"), y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"), b = t.get("splitNumber"), w = x.get("splitNumber"), S = l(y.get("length"), g), M = l(x.get("length"), g), T = u, A = (h - u) / b, I = A / w, L = y.getModel("lineStyle").getLineStyle(), C = x.getModel("lineStyle").getLineStyle(), D = _.getModel("textStyle"), P = 0; b >= P; P++) {
          ...
          if (y.get("show")) {
            ...
            "auto" === L.stroke && O.setStyle({
              stroke: n(P / b)
            }), d.add(O)
          }
          if (_.get("show")) {
            var E = r(s.round(P / b * (m - v) + v), _.get("formatter")),
              R = _.get("distance"),
              N = new a.Text({
                style: {
                  text: E,
      ...
      _renderPointer: function(t, e, i, n, r, u, h, c) {
        ...
        p.diff(g).add(function(e) {
          ...
          }, t), v.add(i), p.setItemGraphicEl(e, i)
        }).update(function(e, i) {
          ...
          }, t), v.add(n), p.setItemGraphicEl(e, n)
        }).remove(function(t) {
...
function(t, e, i) {
  var n = i(2),
    r = i(1);
  i(265), i(266), i(275), n.registerProcessor(i(268)), n.registerVisual(r.curry(i(46), "graph", "circle", null)), n.registerVisual(i(269)), n.registerVisual(i(272)), n.registerLayout(i(276)), n.registerLayout(i(270)), n.registerLayout(i(274)), n.registerCoordinateSystem("graphView", {
    create: i(271)
  })
},
function(t, e, i) {
    ...
    t.eachSeriesByType("graph", function(t) {
      ...
      i.each(function(n) {
        ...
        var a = i.getItemModel(n),
          s = a.get("itemStyle.normal.color") || t.getColorFromPalette(o, e);
  ...
  t.exports = i(2).extendChartView({
    ...
    _renderOnCartesian: function(t, e, i) {
      var n = t.getAxis("x"),
        ...
        v = e.getModel(d).getItemStyle(),
        m = e.getModel("label.normal"),
    ...
    _renderOnGeo: function(t, e, i, o) {
      ...
      var p = Math.max(d.x, 0),
        g = Math.max(d.y, 0),
        v = Math.min(d.width + d.x, o.getWidth()),
        m = Math.min(d.height + d.y, o.getHeight()),
        y = v - p,
        x = m - g,
...
function(t, e, i) {
  ...
  f.stopEffectAnimation = function() {
    ...
    var d = {};
    if (d.showEffectOn = i.get("showEffectOn"), d.rippleScale = o.get("rippleEffect.scale"), d.brushType = o.get("rippleEffect.brushType"), d.period = 1e3 * o.get("rippleEffect.period"), d.effectOffset = e / t.count(), d.z = o.getShallow("z") || 0, d.zlevel = o.getShallow("zlevel") || 0, d.symbolType = a, d.color = l, this.off("mouseover").off("mouseout").off("emphasis").off("normal"), "render" === d.showEffectOn) this._effectCfg ? this.updateEffectAnimation(d) : this.startEffectAnimation(d), this._effectCfg = d;
    else {
...
function(t, e, i) {
  ...
  c._createContent = function(t, e, i) {
    ...
    this.add(new l.Polygon({
      shape: {
        points: i ? r(n.bodyEnds, a, n) : n.bodyEnds
      },
      style: {
        strokeNoScale: !0
      },
  ...
  i(2).extendChartView({
    ...
    render: function(t, e, i) {
      ...
      var p = t.get("zlevel"),
        ...
        v = i.getZr();
      if (v.painter.getLayer(p).clear(!0), null != this._lastZlevel && v.configLayer(this._lastZlevel, {
          motionBlur: !1
        }), c && g) {
        v.configLayer(p, {
          motionBlur: !0,
    ...
    t.eachSeriesByType("lines", function(t) {
      ...
      i.each(function(n) {
        var r = i.getItemModel(n),
          o = r.option instanceof Array ? r.option : r.get("coords"),
          a = [];
        if (t.get("polyline"))
          for (var s = 0; s < o.length; s++) a.push(e.dataToPoint(o[s]));
        else {
          a[0] = e.dataToPoint(o[0]), a[1] = e.dataToPoint(o[1]);
          var l = r.get("lineStyle.normal.curveness"); + l && (a[2] = [(a[0][0] + a[1][0]) / 2 - (a[0][1] - a[1][1]) * l, (a[0][1] + a[1][1]) / 2 - (a[1][0] - a[0][0]) * l])
        }
        i.setItemLayout(n, a)
      })
    })
          ...
          if (a && a.point) {
            ...
            if (!l) {
              var h = t.mainSeries.getData(),
                ...
                p = r.getItemModel(i),
                g = p.getModel("label.normal"),
                v = p.getModel("label.emphasis"),
                m = g.getModel("textStyle"),
                y = v.getModel("textStyle"),
    ...
    getInitialData: function(t, e) {
      var i = e.getComponent("parallel", this.get("parallelIndex")),
        ...
        d = s.map(c, function(t, i) {
          var o = s.indexOf(h, t),
            a = o >= 0 && e.getComponent("parallelAxis", r[o]);
          return a && "category" === a.get("type") ? (n(a, t, l), {
            name: t,
            type: "ordinal"
          }) : 0 > o && u.guessOrdinal(l, i) ? {
            name: t,
            type: "ordinal"
          } : t
        }),
...
function(t, e, i) {
  function n(t, e, i) {
    ...
    return o.setShape(a, 0), l.initProps(o, {
      shape: {
        width: r.width,
        height: r.height
      }
  ...
  t.exports = function(t) {
    t.eachSeriesByType("parallel", function(e) {
      var i = e.getModel("itemStyle.normal"),
        ...
        r = t.get("color"),
        o = n.get("color") || i.get("color") || r[e.seriesIndex % r.length],
    ...
    render: function(t, e, i) {
      ...
      function l(e, i, n, o, a, l) {
        ...
        for (var u = 0; u < i.length - 1; u++) {
          var h = s(o, a);
          h && (h.__dimIdx = u, e[u] ? (h.attr("position", e[u]), r[l ? "initProps" : "updateProps"](h, {
            position: i[u]
      ...
      d.diff(f).add(function(e) {
        ...
        h.eachChild(function(e) {
          ...
          r.setText(e.style, _, f), e.setStyle({
            text: _.get("show") ? o.retrieve(t.getFormattedLabel(i, "normal", null, e.__dimIdx), n) : ""
          }), r.setText(e.hoverStyle, b, f), e.hoverStyle.text = b.get("show") ? o.retrieve(t.getFormattedLabel(i, "emphasis", null, e.__dimIdx), n) : ""
  ...
  t.exports = i(2).extendChartView({
    ...
    render: function(t, e, i) {
      ...
      this._model = t, l.removeAll(), l.position = [u.x, u.y], s.eachEdge(function(e) {
        ...
        d.setStyle(o.defaults({
          fill: e.getVisual("color")
        }, n.getModel("itemStyle.normal").getItemStyle())), r.setHoverStyle(d, o.extend(e.getModel("itemStyle.emphasis"), {
  ...
  n.prototype = {
    ...
    _prepare: function(t, e, i, n) {
      for (var r = e; r; r = r.parentNode) {
        ...
        i.totalWidth += s + u, i.renderList.push({
          node: r,
          text: o,
          width: s
        })
    ...
    _renderContent: function(t, e, i, n, l) {
      for (var h = 0, c = i.emptyItemWidth, d = t.get("height"), f = a.getAvailableSize(i.pos, i.box), p = i.totalWidth, g = i.renderList, v = g.length - 1; v >= 0; v--) {
        ...
        p > f.width && (p -= y - c, y = c, x = ""), this.group.add(new o.Polygon({
          shape: {
            points: r(h, 0, y, d, v === g.length - 1, 0 === v)
          },
...
function(t, e, i) {
  ...
  function r(t, e, i, n, r, l, u, h, c, d) {
    ...
    function y(t, e, i, n, r, o, a) {
      ...
      !l.getShallow("show") || h.height > a ? e.text = "" : h.width > o ? e.text = u.get("ellipsis") ? u.truncateText(t, o, null, {
        minChar: 2
      }) : "" : e.text = t
    }
  ...
  t.exports = i(2).extendChartView({
    ...
    render: function(t, e, i, n) {
      ...
      if (!(a.indexOf(r, t) < 0)) {
        ...
        var o = u.retrieveTargetInfo(n, t),
          s = n && n.type,
          l = t.layoutInfo,
          h = !this._oldTree,
          c = this._storage,
          d = "treemapRootToNode" === s && o && c ? {
    ...
    _onZoom: function(t, e, i) {
      if (this._mayClick = !1, "animating" !== this._state) {
        ...
        var r = n.getLayout();
        if (!r) return;
        var o = new d(r.x, r.y, r.width, r.height),
    ...
    _renderBreadcrumb: function(t, e, i) {
      ...
      })), (this._breadcrumb || (this._breadcrumb = new h(this.group, g(n, this)))).render(t, e, i.node)
    },
    remove: function() {
...
function(t, e, i) {
  for (var n = i(2), r = i(170), o = function() {}, a = ["treemapZoomToNode", "treemapRender", "treemapMove"], s = 0; s < a.length; s++) n.registerAction({
    type: a[s],
    update: "updateView"
  }, o);
  n.registerAction({
  ...
  function n(t, e, i) {
    ...
    t.eachComponent(n, function(t) {
      var n = e.getWidth(),
        ...
        h = v.getLayoutRect(t.getBoxLayoutParams(), {
          width: e.getWidth(),
          height: e.getHeight()
        }),
        g = i && i.type,
        x = m.retrieveTargetInfo(i, t),
        _ = "treemapRender" === g || "treemapMove" === g ? i.rootRect : null,
        M = t.getViewRoot(),
        T = m.getPathToRoot(M);
      if ("treemapMove" !== g) {
        var A = "treemapZoomToNode" === g ? c(t, x, M, l, u) : _ ? [_.width, _.height] : [l, u],
          I = a.sort;
    ...
    _axisLabel: function(t, e, i, n) {
      for (var r = t.axis, s = t.get("data"), l = t.getModel("axisLabel"), u = l.getModel("textStyle"), h = t.getFormattedLabels(), c = l.get("margin"), d = r.getLabelsCoords(), f = 0; f < i.length; f++) {
        var p = n[1],
          ...
          x = Math.abs(g[1] - m) / p < .3 ? "middle" : g[1] > m ? "top" : "bottom",
          _ = u;
  ...
  var r = i(1),
    ...
    u = i(2).extendComponentView({
        ...
        if (!n(t, e, a)) {
          ...
          if (this._axisGroup = new s.Group, this.group.add(this._axisGroup), t.get("show")) {
            var h, c = e.getComponent("parallel", t.get("parallelIndex")).coordinateSystem,
              ...
              p = t.axis.dim,
              g = c.getAxisLayout(p),
              v = r.indexOf(c.dimensions, p),
              m = g.axisExpandWindow;
            m && (v <= m[0] || v >= m[1]) && (h = !1);
            var y = r.extend({
                axisLabelShow: h,
      ...
      _refreshBrushController: function(t, e, i, n) {
        var o = i.axis,
          a = r.map(i.activeIntervals, function(t) {
            return {
              brushType: "lineX",
              panelId: "pl",
    ...
    c = i(2).extendComponentView({
      ...
      _splitLine: function(t, e) {
        var i = t.axis,
          ...
          h = s(n, e);
        u = u instanceof Array ? u : [u];
        for (var c = t.coordinateSystem.getRect(), d = i.isHorizontal(), f = [], p = 0, g = i.getTicksCoords(), v = [], m = [], y = 0; y < g.length; ++y)
          if (!l(i, y, h)) {
...
function(t, e, i) {
  var n = i(2),
    ...
    l = n.extendComponentModel({
      ...
      optionUpdated: function(t, e) {
        var i = this.option;
        !e && o.replaceVisualOption(i, t, ["inBrush", "outOfBrush"]), i.inBrush = i.inBrush || {}, i.outOfBrush = i.outOfBrush || {
          color: s
        }
      },
      setAreas: function(t) {
  ...
  h.registerLayout(_, function(t, e, i) {
    t.eachComponent({
      ...
      i && "takeGlobalCursor" === i.type && e.setBrushOption("brush" === i.key ? i.brushOption : {
        brushType: !1
      }), e.coordInfoList = v.makeCoordInfoList(e.option, t), v.parseInputRanges(e, t)
    })
...
function(t, e, i) {
  "use strict";
  i(215), i(317), i(336), i(2).extendComponentView({
    type: "polar"
  })
},
function(t, e, i) {
      ...
      if (a.length) {
        ...
        if ("circle" === s)
          for (var y = a[0].getTicksCoords(), x = i.cx, _ = i.cy, b = 0; b < y.length; b++) {
            ...
            for (var S = r.map(a, function(t, e) {
...
function(t, e, i) {
  ...
  t.exports = h.extend({
    ...
    _layout: function(t, e) {
      ...
      g = g * b / 180;
      var v, m, y, x, _ = h.get("position", !0),
        c = h.get("show", !0),
    ...
    _renderAxisLabel: function(t, e, i, n) {
      ...
      if (r.get("show")) {
        var o = n.getData(),
          a = i.scale.getTicks(),
          s = f.getFormattedLabels(i, r.get("formatter")),
          u = i.getLabelInterval();
        _(a, function(n, r) {
          if (!i.isLabelIgnored(r, u)) {
            var a = o.getItemModel(r),
    ...
    w = l.extend({
      ...
      _updateView: function(t) {
        var e = this.visualMapModel,
          ...
          a = this._createBarVisual(this._dataInterval, i, o, "inRange"),
...
function(t, e, i) {
  ...
  function r(t) {
    ...
    for (var i = -(1 / 0), n = 0; n < t.length; n++)
      for (var r = t[n].interval, o = t[n].close, a = 0; 2 > a; a++) r[a] < i && (r[a] = i, o[a] = 1 - a), i = r[a]
  }
  var o = i(230),
    a = i(1),
    s = i(71),
          ...
          if (null != t.label && (n.text = t.label), t.hasOwnProperty("value")) {
            ...
            for (var o = n.interval = [], l = n.close = [0, 0], u = [1, 0, 1], h = [-(1 / 0), 1 / 0], c = [], d = 0; 2 > d; d++) {
              for (var f = [
                  ["gte", "gt", "min"],
                  ["lte", "lt", "max"]
                ][d], p = 0; 3 > p && null == o[d]; p++) o[d] = t[f[p]], l[d] = u[p], c[d] = 2 === p;
              null == o[d] && (o[d] = h[d])
            }
...
function(t, e, i) {
  for (var n = i(238), r = [126, 25], o = [
    ...
    for (var s = 0; s < o[a].length; s++) o[a][s][0] /= 10.5, o[a][s][1] /= -14, o[a][s][0] += r[0], o[a][s][1] += r[1];
  t.exports = function(t) {
...
function(t, e, i) {
  function n(t) {
    ...
    for (var e = t.features, i = 0; i < e.length; i++)
      for (var n = e[i], o = n.geometry, a = o.coordinates, s = o.encodeOffsets, l = 0; l < a.length; l++) {
        var u = a[l];
        if ("Polygon" === o.type) a[l] = r(u, s[l]);
  ...
  n.prototype = {
    ...
    _layoutAxes: function(t) {
      ...
      var f, p = t.get("axisExpandable"),
        ...
        v = t.get("axisExpandCenter"),
        m = t.get("axisExpandCount") || 0;
      if (null != v) {
        var y = Math.max(0, Math.floor(v - (m - 1) / 2)),
          x = y + m - 1;
      ...
      for (var n = this.dimensions, r = this._axesMap, o = this.hasAxisbrushed(), a = 0, s = t.count(); s > a; a++) {
        ...
        if (o) {
          ...
          for (var h = 0, c = n.length; c > h; h++) {
            var d = n[h],
              f = r[d].model.getActiveState(u[h], h);
            if ("inactive" === f) {
              l = "inactive";
              break
            }
    ...
    findClosestAxisDim: function(t) {
      ...
      return a.each(this._axesLayout, function(n, r) {
        var o = l.applyTransform(t, n.transform, !0),
          a = this._axesMap[r].getExtent();
        if (!(o[0] < a[0] || o[0] > a[1])) {
          var s = Math.abs(o[1]);
          i > s && (i = s, e = r)
        }
  ...
  n.prototype.getIndicatorAxes = function() {
    ...
    r.each(n, function(t, e) {
      ...
      var r = t.model,
        ...
        h = r.get("max"),
        c = o.getInterval();
      if (null != u && null != h) o.setInterval((h - u) / a);
      else if (null != u) {
        var d;
  ...
  n.prototype = {
    ...
    _init: function(t, e, i) {
      var n = this.dimension,
        a = new r(n, o.createScaleByModel(t), [0, 0], t.get("type"), t.get("position")),
        s = "category" === a.type;
